...
const LandingPage = () => {
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* Navbar */}
      <nav className="text-[#224AA0] p-4 md:p-6 flex justify-between items-center">
        <div>
        ...
        <div className="flex items-center">
          ...
          <div className={`md:flex ${isOpen ? 'block' : 'hidden'}`}>
            <div className="md:mr-4">
              <Link
                to="/patient/login"
                className="block md:inline text-black py-2 px-3 border border-gray-500 text-lg md:mb-0"
              >
                Login
              </Link>
            </div>
            <div>
              <Link
                to="/patient/register"
                className="block md:inline bg-[#224AA0] text-white py-2 px-3 rounded text-lg"
              >
                Sign Up
              </Link>
            </div>
      ...
      {/* Body */}
      <div className="container mx-auto mt-6 p-4 md:p-8 text-center">
        {/* First div */}
        <div className="flex flex-col-reverse md:flex-row mb-4 md:mb-8 items-center">
          <div className="md:w-1/2 mb-4 md:mb-0 text-center md:text-left md:pr-4">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#224AA0]">Get prescribed medications with the help of our solution</h2>
        ...
        {/* Second div */}
        <div className="flex flex-col items-center md:flex-row md:justify-between mb-6 md:mb-9 pb-6 md:pb-9 text-[#224AA0]">
          {/* ... */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {/* ... */}
          <div className="bg-[#224AA0] p-4 rounded-md text-white flex flex-col items-center">
      ...
      {/* Footer */}
      <div className='bg-[#224AA0] text-white mt-6 md:mt-10 p-4 md:p-11'>
        {/* ... */}
        <div className='text-center'>
          <hr className="w-1/2 mx-auto my-6" />
          <p className='mt-4 text-bold'>All Rights Reserved</p>
        </div>
        <div className="flex justify-center items-center space-x-4 mb-4 mt-4 md:mt-7">
